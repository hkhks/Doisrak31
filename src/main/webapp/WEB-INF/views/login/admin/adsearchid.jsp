...
<body>
   <div id="container">
        ...
        <form action="/admin/adidconfirm" method="POST" id="idSearchForm">
            ...
            <div class="input-box">
                <input id="admin_name" type="text" name="admin_name" placeholder="아이디">
                <label for="admin_name">이름</label>
            </div>

            <div class="input-box">
                <input id="admin_phone" type="text" name="admin_phone" placeholder="전화번호">
                <label for="admin_phone">전화번호</label>
            </div><br/><br/>
            
            
         <div class ="return">
               <span><a href="/admin/adsearchpw">비밀번호 찾기</a></span> | <span><a href="/admin/login">로그인 하기</a></span>
            </div>
            
            <div id="btn"> 
               <input type="submit" value="아이디 찾기" id="idsearchBtn" class="dosirakBtn">
         </div>
